...
The shell was upgraded using `python3 -c 'import pty;pty.spawn("/bin/bash")'` before moving on. This process can be accomplished by completing the following steps: <h6 id="shell_upgrade"></h6>
